 ...
 * @date 2025-01-01
 */
@FeignClient(contextId = "remoteClientDetailsService", value = ServiceNameConstants.UPMS_SERVICE, primary = false)
public interface RemoteClientDetailsService extends ClientDetailsQueryService {
