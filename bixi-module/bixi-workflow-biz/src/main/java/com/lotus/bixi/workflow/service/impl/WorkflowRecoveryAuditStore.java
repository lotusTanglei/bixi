...
/** Persists operator recovery actions independently from the delivery transaction. */
@Service
@ConditionalOnWorkflowEnabled
@ConditionalOnProperty(prefix = "bixi.reliable", name = "enabled", havingValue = "true")
public class WorkflowRecoveryAuditStore {
    private final JdbcTemplate jdbc;
    private final TransactionTemplate transaction;

    public WorkflowRecoveryAuditStore(DataSource dataSource,
