...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {  //获取控制台的数据
        ...
        dsc.setUrl("jdbc:mysql://rm-bp1c485wpa4uwapa8ho.mysql.rds.aliyuncs.com:3306/bixi?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowPublicKeyRetrieval=true");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("!QAZ4esz");
