export default {
	...
	user: {
		...
		newUnreadTab: 'Unread',
		newReadTab: 'Read',
		newDeleteConfirm: 'Are you sure you want to delete this notice?',
		newAllReadConfirm: 'Are you sure you want to mark all as read?',
		newAllDeleteConfirm: 'Are you sure you want to delete all notices?',
		newDesc: 'No Notice',
		logOutTitle: 'Tips',
