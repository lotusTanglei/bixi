...
public class BixiAuthenticationSuccessEventHandler implements AuthenticationSuccessHandler {
    ...
    private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new BixiCustomOAuth2AccessTokenResponseHttpMessageConverter();
