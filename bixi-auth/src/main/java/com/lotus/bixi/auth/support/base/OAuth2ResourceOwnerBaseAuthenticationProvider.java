package com.lotus.bixi.auth.support.base;

import cn.hutool.extra.spring.SpringUtil;
import com.lotus.bixi.common.security.util.OAuth2ErrorCodesExpand;
import com.lotus.bixi.common.security.util.ScopeException;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            ...
            usernamePasswordAuthenticationToken.setDetails(registeredClient.getClientId());
