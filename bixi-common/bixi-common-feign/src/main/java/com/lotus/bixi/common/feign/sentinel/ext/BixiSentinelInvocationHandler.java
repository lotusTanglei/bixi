...
package com.lotus.bixi.common.feign.sentinel.ext;
 ...
 */
@Slf4j
public class BixiSentinelInvocationHandler implements InvocationHandler {
    ...
    BixiSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            BixiSentinelInvocationHandler other = (BixiSentinelInvocationHandler) obj;
