...
public class BixiResourceServerAutoConfiguration {
     ...
     */
    @Bean
    public BixiBearerTokenExtractor bixiBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
        return new BixiBearerTokenExtractor(urlProperties);
    }
    ...
    public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
        return new BixiCustomOpaqueTokenIntrospector(authorizationService);
    }
